...
const LIVE_BASE = "https://codebymudsser.com";
const demo = (slug) => `/demos/${slug}`;
...
export const projects = [
  {
    ...
    details:
      "A fully animated portfolio featuring MERN stack slider, profile section, project showcase, contact form, and mobile-friendly navigation. Deployed on codebymudsser.com with static export support for shared hosting.",
  },
  {
    id: 2,
